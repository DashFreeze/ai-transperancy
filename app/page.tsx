...
export default function DD() {
    ...
    return (
        ...
        >
            ...
            <p style={{ marginBottom: '20px' }}>
                Ziel dieser Forschung ist es, zu untersuchen, wie der Einfluss der Glaubwürdigkeit bei Quellenangaben
                die Qualität und Zuverlässigkeit der Antworten von AI-Systemen beeinflusst. Ihre Teilnahme hilft uns,
            ...
            >
                ...
                <div style={{ marginRight: '20px' }}>
                    <h3 style={{ color: '#ffffff', marginBottom: '10px', textDecoration: 'underline' }}>Versuchsdurchführende:</h3>
                ...
                {/* Versuchsleitung */}
                <div>
                    <h3 style={{ color: '#ffffff', marginBottom: '10px', textDecoration: 'underline' }}>Versuchsleitung:</h3>
                    <ul style={{ listStyleType: 'none', padding: 0, textAlign: 'left' }}>
